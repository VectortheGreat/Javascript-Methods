...
const StringDetail = () => {
  ...
  const [stringDsc2, setStringDsc2] = useState(`const string4 = new String("A String object");`);
  return (
    <div>
      <h1 className="text-4xl font-bold mb-4">String</h1>
      <p className="mb-6">The String object is used to represent and manipulate a sequence of characters.</p>
